...
//ä»¥åŠ¨ç”»å½¢å¼çš„ show, hide, toggle, å’Œ fade*()æ–¹æ³•.
...
//cookieæ’ä»¶ä¿®æ”¹ä½¿ç”¨H5 localStorageå‚¨å­˜
(function(a){function b(){}function c(){var a,b=new RegExp("(^| )"+name+"=([^;]*)(;|$)");return(a=document.cookie.match(b))?unescape(a[2]):null}function d(){var a=new Date;a.setTime(a.getTime()-1);var b=c(name);null!=b&&(document.cookie=name+"="+b+";expires="+a.toGMTString())}function e(){return"undefined"!=typeof Storage}b.prototype.set=function(a,b){e()?localStorage[a]=b:document.cookie=a+"="+b},b.prototype.get=function(a){return a?e()?localStorage[a]:c(a):e()?localStorage:document.cookie},b.prototype.remove=function(a){e()?(console.log(a),localStorage.removeItem(a)):d(a)},a.Cookies=new b})(window);
